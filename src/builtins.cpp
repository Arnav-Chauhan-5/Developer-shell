...
std::string HelpCommand::getDescription() const { return "Show available commands"; }
...
std::string EchoCommand::getDescription() const { return "Print arguments to output"; }
